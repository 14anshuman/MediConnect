  ...
  return (
    <div className="bg-background">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-300  leading-tight">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <Card className="bg-gradient-to-r from-emerald-600/30 to-emerald-700/20 border-emerald-800/20">
